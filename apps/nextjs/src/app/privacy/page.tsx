...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto flex flex-col gap-4 max-w-xl">
      ...
      <div className="space-y-4">
        <section>
          ...
          <p>
            ...
            you use our bulk image and video downloading service.
          </p>
        </section>
        <section>
          ...
          <p>
            We do not collect any personal information from our users. The only
            data we collect is anonymous telemetry data using PostHog to help us
        ...
        <section>
          ...
          <p>
            ...
            personally identifiable data for you to access, correct, or delete.
            The telemetry data we collect is completely anonymous.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-semibold mb-2">
