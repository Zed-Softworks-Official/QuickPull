          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                QuickPull makes it easy to download collections of images. Save
                time and streamline your workflow.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <Card>
              ...
              <CardContent>
                <p>
                  Download multiple files simultaneously, saving you time and
                  effort.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p>
                  Support for various image formats including JPEG, PNG, GIF,
                  and more.
                </p>
              </CardContent>
            </Card>
